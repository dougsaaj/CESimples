...
type
  ...
  public
    ...
    procedure ExecuteSQL(Transacao: Boolean); overload;
...
begin
  ...
  FTransacao := DMCE.Conn.BeginTransaction(TDBXIsolations.ReadCommitted);
end;
...
begin
  ...
  DMCE.Conn.RollbackFreeAndNil(FTransacao);
end;
